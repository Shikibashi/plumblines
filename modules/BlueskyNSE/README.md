...
- **App Group**: `group.uk.plumblines.app` allows data sharing between the main app and the extension
...
The extension requires the `group.uk.plumblines.app` App Group to be configured in:
