...
The 2026-09-23 newspaper continuation deployment is `93d682e7-24b5-4c08-a7c6-67c99885b59d`, at `https://93d682e7.plumbline-f50.pages.dev`. The previous production deployment, available as the rollback target, is `08bd8ccc-1600-4c98-acaf-588ed144fc43`, at `https://08bd8ccc.plumbline-f50.pages.dev`. Both IDs were recorded from Wrangler's live Pages deployment list after promotion. See the [deployment receipt](../../docs/zeus/editorial-frontpage-follow-up-deployment-2026-09-23.md) for artifact hashes and hosted browser verification.
