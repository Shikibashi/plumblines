...
The main page has no nested section scrollbars. Its opening packages form the composed lead, briefs and secondary fronts, then a **More dispatches** continuation keeps the chosen lead source flowing below them without repeating the opening four items. Both this continuation and individual section fronts request the next cursor page as the reader nears the end; visible load-more controls remain as manual and keyboard fallbacks. On phones the front-page regions flatten to one column, with section labels, editorial rules and at least 44px section controls retained. A slim desktop utility rail preserves the established app navigation.
